  ...
  return (
    <div className="page-container !items-start !max-w-full lg:px-10">
      <header className="flex flex-col gap-6 mb-8 w-full">
        ...
        {/* Search and Sort Bar */}
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between bg-white/5 p-4 rounded-2xl border border-white/10 w-full shadow-drop-1">
          <div className="w-full lg:max-w-xl">
            <Search />
          </div>
          <div className="flex items-center gap-4 w-full lg:w-auto justify-end shrink-0">
            <p className="body-1 hidden text-light-200 sm:block">Sort:</p>
            <Sort />
          </div>
        </div>
