      ...
      <section className="w-full max-w-2xl mx-auto">
        ...
        <div className="p-6 rounded-lg border border-red/30 bg-red/10 shadow-drop-1 mb-6">
          <p className="body-2 text-red font-medium mb-4">
            S3 configuration not found or incomplete. Please configure your AWS credentials.
          </p>
          <Button
        ...
        <div className="p-6 rounded-lg border border-blue/30 bg-blue/10 shadow-drop-1">
          <p className="body-2 text-blue font-medium mb-3">What works with Private S3:</p>
          <ul className="caption text-blue/80 space-y-2 mb-4">
            ...
            <li>• <strong className="text-blue font-semibold">Global Search</strong> - Seamless search across your entire bucket</li>
            ...
            <li>• <strong className="text-blue font-semibold">Pure S3</strong> - All operations happen directly in your S3 bucket with zero server-side database dependency.</li>
          </ul>
        </div>

        <div className="mt-6 text-center">
          <Link href="/private/explorer" className="body-2 text-light-200 hover:text-light-100 transition-colors">
