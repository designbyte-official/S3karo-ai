...
export const useFileUploader = (ownerId: string, accountId: string, mode: "managed" | "private" = "managed", uploadPath: string = "") => {
    ...
    const onDrop = useCallback(async (acceptedFiles: File[], fileRejections: any[]) => {
        ...
        const uploadPromises = acceptedFiles.map(async (file) => {
            ...
            try {
                ...
                const errorMessage = error instanceof Error ? error.message : String(error?.message || 'Unknown error occurred');
                toast({
                    title: "Upload Failed",
