      ...
      >
        ...
        {(title || header) && (
          <DialogHeader className={cn(
            ...
            {header || (title && <DialogTitle className={cn(
              isFullScreen ? "text-lg font-semibold text-slate-800 truncate flex-1" : "text-center text-light-100"
            )}>{title}</DialogTitle>)}
          </DialogHeader>
        )}
