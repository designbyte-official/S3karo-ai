      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-16 space-y-8 text-center lg:mb-20">
          ...
          <div className="flex flex-col items-center justify-center gap-5 pt-4 sm:flex-row">
            ...
            <Link href="#features">
              <Button variant="outline" className="button h-[60px] rounded-full border-2 border-light-200 bg-white px-10 text-lg font-semibold hover:bg-light-300">
                Learn More
              </Button>
            </Link>
          </div>
          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-brand-50 via-brand-75/30 to-white p-8 lg:p-12">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              {[
                ...
                >
                  <div className={`size-16 bg-gradient-to-br ${file.color} mb-6 flex items-center justify-center rounded-2xl transition-transform duration-300 group-hover:scale-110`}>
