...
export const S3ConfigForm = ({ userId, onConfigSaved, defaultValues }: S3ConfigFormProps) => {
    ...
    const {
        ...
        isEditMode,
        setIsEditMode
    } = useS3ConfigSync(userId, !defaultValues?.bucket);
            ...
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-6 rounded-xl bg-light-400/5 border border-light-300/20">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button variant="outline" size="sm" className="text-red hover:text-red" onClick={() => handleReset(onReset)}>Reset</Button>
                    </div>
                </div>
