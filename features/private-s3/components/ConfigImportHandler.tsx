    ...
    >
      <DialogContent className="shad-dialog">
        <DialogHeader className="flex flex-col gap-3">
          <DialogTitle
            className={`text-center sm:text-left ${errorType === "expired" ? "text-red" : ""}`}
          >
          ...
          <DialogDescription className="text-center sm:text-left">
            {errorType === "expired" ? (
              ...
              <>
                A shared S3 configuration has been detected. Would you like to import it into your
                secure local vault? <br />
                <br />
                <span className="font-medium text-red">
                  Warning: This will replace your current S3 settings.
                </span>
              </>
            )}
          </DialogDescription>
        ...
        <DialogFooter className="flex flex-col gap-3 md:flex-row">
          <Button variant="ghost" onClick={handleCancel} className="modal-cancel-btn">
