...
export function generateStorageKey(userId: string, fileName: string, path?: string): string {
...
export function validateStorageKeyOwnership(storageKey: string, userId: string): boolean {
